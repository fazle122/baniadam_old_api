...
class CurrentShiftEmployeeListPage extends StatefulWidget {
  CurrentShiftEmployeeListPage({
    Key key,
  }) : super(key: key);

  @override
  _CurrentShiftEmployeeListPageState createState() =>
      _CurrentShiftEmployeeListPageState();
}

class _CurrentShiftEmployeeListPageState
    extends BaseState<CurrentShiftEmployeeListPage> {
...
//        child:
      Scaffold(
          appBar: AppBar(
            title: Text('Employees to attened'),
            actions: <Widget>[
              IconButton(
