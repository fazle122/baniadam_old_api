...
class DayOffEmployeeListPage extends StatefulWidget {
  DayOffEmployeeListPage({
    Key key,
  }) : super(key: key);

  @override
  _DayOffEmployeeListPageState createState() =>
      _DayOffEmployeeListPageState();
}

class _DayOffEmployeeListPageState
    extends BaseState<DayOffEmployeeListPage> {
...
//    });
  ...
  void _getAttendanceList() async {
    ...
    Map<String, dynamic> attendenceData =
        await ApiService.getDayOffEmployee();
