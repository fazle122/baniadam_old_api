...
//    });
  ...
  void _getAttendanceList() async {
    ...
    switch (widget.listType) {
      case 'empToAttened':
      listData = await ApiService.getCurrentShiftEmployee();
      break;
      case 'dayOff':
        listData = await ApiService.getDayOffEmployee();
        break;
      case 'onTime':
        listData = await ApiService.getOnTimeEmployee();
        break;
      case 'late':
        listData = await ApiService.getLateEmployee();
        break;
      case 'present':
        listData = await ApiService.getPresentEmployee();
        break;
      case 'absent':
        listData = await ApiService.getAbsentEmployee();
        break;
      case 'onLeave':
        listData = await ApiService.getOnleaveEmployee();
        break;
    ...
    if (listData != null) {
      ...
      setState(() {
        ...
        attendanceList.addAll(listData['data']);
      });
    }
  }
...
class ListItemWidget extends StatefulWidget {
  ...
  _ListItemWidgetState createState() =>
      _ListItemWidgetState();
}

class _ListItemWidgetState
    extends BaseState<ListItemWidget> {
