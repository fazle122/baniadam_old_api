//import 'dart:math';
//
//import 'package:baniadam/screens/approver/ListPage.dart';
//import 'package:baniadam/screens/approver/current_shift_employee_list.dart';
//import 'package:baniadam/screens/approver/dayOff_employee.dart';
//import 'package:baniadam/screens/approver/onTime_employee_list.dart';
...
//  String notificationHelper = "helper";
...
//          notificationHelper = "You have recieved a new notification";
//        });
//
//      },
...
//          notificationHelper = "You have open the application from notification";
//        });
//
//      },
//
...
//    if (detailData != null) {
//      setState(() {
//        personalDetail = detailData['data'];
...
////      }
//
//      final Map<String,dynamic> personalAttendenceData =
//      await ApiService.getCurrentDatePersonalAttendanceList1();
//      if (personalAttendenceData != null) {
//        setState(() {
//          personalAttendenceList.addAll(personalAttendenceData['data']);
//        });
//      }
//    }
//  }
...
//    if (trackData != null) {
//      print(trackData['data']);
//      setState(() {
//        trackableEmployee = trackData.length;
//      });
//    }
//  }
//
...
//      List empToAttend = dashBoardData['data']['current_shift_employees'];
//      List empOnleave = dashBoardData['data']['onleave']['data'];
//      List empLate = dashBoardData['data']['late']['data'];
//      List empDayOff = dashBoardData['data']['offday_employees'];
//      absentEmployeeList = dashBoardData['data']['absent_employees'];
//      onLeaveEmployeeList = dashBoardData['data']['onleave']['data'];
//      lateEmployeeList = dashBoardData['data']['late']['data'];
//      setState(() {
//        empPresent = empToAttend.length != null ? empToAttend.length : '0';
//        onTime = dashBoardData['data']['late']['total'] != null
//            ? dashBoardData['data']['total_present'] - dashBoardData['data']['late']['total']
//            : '0';
//        late = empLate.length == null ? 0 : empLate.length;
//        onLeave = empOnleave.length == null ? 0 : empOnleave.length;
//        dayOff = empDayOff.length;
//        absent = dashBoardData['data']['total_absent'];
//
//        totalPendingAttendancesToday = dashBoardData['data']['total_present'] != null &&
//            dashBoardData['data']['total_present'].toString() != 'n/a'
//            ? dashBoardData['data']['total_present']
//            : '0';
//        totalPendingLeaveApplications =
//        dashBoardData['data']['total_pending_leave_applications'] != null ||
//            dashBoardData['data']['total_pending_leave_applications'] != 'n/a'
//            ? dashBoardData['data']['total_pending_leave_applications']
//            : '0';
...
//      setState(() {
//        personalDetail = detailData;
//        photoUrl = personalDetail['data']['photoAttachment'];
//      });
//    }
//    setState(() {
...
//                    context,
//                    MaterialPageRoute(
//                        builder: (context) => ListPage(listType: 'empToAttened',title:'Employees to attened')));
////                Navigator.push(
////                    context,
////                    MaterialPageRoute(
////                        builder: (context) => CurrentShiftEmployeeListPage(
////                        )));
//              },
//            ),
//            InkWell(
...
//                    context,
//                    MaterialPageRoute(
//                        builder: (context) => ListPage(listType: 'dayOff',title: 'Day-off today',)));
////                Navigator.push(
////                    context,
////                    MaterialPageRoute(
////                        builder: (context) => DayOffEmployeeListPage(
////                        )));
//              },
//            ),
////            _linkItem2(
...
//                    context,
//                    MaterialPageRoute(
//                        builder: (context) => OnTimeEmployeeListPage(
//                        )));
//              },
//            ),
//            InkWell(
...
//                          listType:'absent',title: 'Absent today',
//                        )));
////                Navigator.push(
////                    context,
////                    MaterialPageRoute(
...
//                  value: trackableEmployee.toString(),
//                  clickIcon: Icon(
//                    Icons.launch,
//                    size: 15.0,
//                    color: Colors.black,
