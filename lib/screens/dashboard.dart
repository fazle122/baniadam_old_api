...
import 'package:baniadam/screens/approver/absent_employee_list.dart';
...
class _DashboardPageState extends BaseState<DashboardPage> {
  ...
  void initState() {
    ...
    if (widget.attendanceId != null && widget.attendanceSelfie != null) {
      Utility.updateSelfie(widget.attendanceId, widget.attendanceSelfie);
    }
  ...
  void _getEmployeeDetail() async {
    ...
    if (detailData != null) {
      setState(() {
        personalDetail = detailData;
        id = detailData['id'];
        empId = detailData['employeeId'];
        userRole = detailData['department']['value'];
...
//              title: Text('BaniAdam HR'),
              title: companyLogo != null
                  ...
                  child: Utility.sizedContainer(context:context,
                    child:CachedNetworkImage(
                      imageUrl: companyLogo,
//                          placeholder: (context, url) =>
//                              new CircularProgressIndicator(),
                      errorWidget: (context, url, error) => Utility.sizedContainer(context:context,
                          child:Image.asset(
...
//    bg.BackgroundGeolocation.onAuthorization(_onAuthorization);
    ...
    print('token in geo :' + currentUserToken);
    print('url in geo :' + url);
    ...
    _firebaseMessaging.configure(
      ...
      onResume: (message) async {
        setState(() {
          ...
          notificationHelper =
          "You have open the application from notification";
        });
      },
    );
  }
