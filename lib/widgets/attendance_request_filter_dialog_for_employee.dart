...
class AttendanceRequestFilterForEmployeeDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _AttendanceRequestFilterForEmployeeDialogState();
  }
}

class _AttendanceRequestFilterForEmployeeDialogState extends BaseState<AttendanceRequestFilterForEmployeeDialog> {
  ...
  @override
  void initState() {
//    _date = DateTime.parse(DateFormat('yyyy-MM-dd').format(DateTime.now()));
    _leaveTypes = new Map();
...
//    List _savedStatusList= pref.getStringList('statusList');
    var list = pref.getString('statusListMine');
//    print(list);
                  ...
                  borderRadius: BorderRadius.all(Radius.circular(3.0)),
                    ...
                    InkWell(
                      ...
                      onTap: () async{
                        ...
                        prefs.setString('statusListMine', json.encode(_mySelectedStatus));
//                      _getAttendanceList();
                        Map<String, dynamic> filters = Map();
                        filters['date'] = _date.toString();
