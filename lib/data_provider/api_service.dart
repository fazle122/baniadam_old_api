...
//  static final String CDN_URl = "http://testcdn.baniadam.info/"; //test
  ...
  static Future<Map<String, dynamic>> createActivityLog(
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token1 = prefs.getString('curr-user');
...
//    await AuthHelper.prefs.remove('curr-user'); //add guest user
//  }
...
//        "http://$cID" +"api.ideaxen.net/" +
  ...
  static Future<Map<String, dynamic>> getAttendanceRequestReasons() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
  ...
  static Future<List<dynamic>> getAttendanceRequestReasons1() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
...
//        "http://$cID" +"api.ideaxen.net/" +
  ...
  static Future<Map<String, dynamic>> getAttendanceRequestListForAdmin(
      Map<String, dynamic> filters) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
...
//                        attendances/attendance/details?employee=2&date=2020-02-3
  ...
  static Future<List<dynamic>> getCurrentDateTrackingDetail(
      empId, date) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
...
//        "http://$cID" + "api.ideaxen.net/" +
  ...
  static Future<Map<String, dynamic>> getAllLeaveTypes() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
    ...
    String qString = BASE_URL +
//        "http://$cID" +"api.ideaxen.net/" +
        "$cID/api/in/v1/utilities/lovs?lov=leave_types";
//    String qString = "http://$cID" +"api.ideaxen.net/" + "leave/balance";
    Map<String, String> headers = {
      'Authorization': 'Bearer ' + token,
      'Content-Type': 'application/json',
    };
  ...
  static Future<List<dynamic>> getLeaveTypesForLeaveApply() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
...
//        "http://$cID" + "api.ideaxen.net/" +
  ...
  static Future<List<dynamic>> getLeaveBalanceForLeaveApply(
...
//      print(responseData);
  ...
  static Future<Map<String, dynamic>> getBranchTypes() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
...
//        "http://$cID" +"api.ideaxen.net/" +
  ...
  static Future<List<dynamic>> getBranchTypes1() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
  ...
  static Future<List<dynamic>> getDepartments1() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
  ...
  static Future<Map<String, dynamic>> getDesignations() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('curr-user');
    var cID = prefs.getString('curr-cid');
